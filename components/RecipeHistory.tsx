...
import { Star, Search, Calendar, LayoutGrid, List, Clock, ChevronDown, ChevronUp, Flame } from 'lucide-react';
            ...
            >
                ...
                {expandedId === item.id && (
                    <div className="px-4 pb-4 pt-0 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800">
                        {item.nutrition && (
                            <div className="flex gap-4 mb-4 mt-4 bg-white dark:bg-slate-800 p-3 rounded-lg border border-slate-100 dark:border-slate-700 text-xs text-slate-600 dark:text-slate-300 justify-around">
                                <div><span className="font-bold">Cal:</span> {item.nutrition.calories}</div>
                                <div><span className="font-bold">Pro:</span> {item.nutrition.protein}</div>
                                <div><span className="font-bold">Carb:</span> {item.nutrition.carbs}</div>
                                <div><span className="font-bold">Fat:</span> {item.nutrition.fats}</div>
                            </div>
                        )}
